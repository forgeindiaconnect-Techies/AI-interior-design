...
const DashboardLayout = ({ children }) => {
  ...
  const allNavItems = [
    ...
    { tab: 'ai_designs',         label: 'AI Design Requests',          icon: Sparkles,      desc: 'Review queued AI design requests',          roles: ['admin'] },
    { tab: 'manual_designs',     label: 'Manual Design Requests',      icon: FileText,      desc: 'Review manual design submissions',          roles: ['admin'] },
    { tab: 'designer_requests',  label: 'Designer Registry',           icon: Star,          desc: 'Interior designer request queue',           roles: ['admin'] },
